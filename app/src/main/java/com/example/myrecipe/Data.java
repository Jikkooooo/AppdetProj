...
public class Data {
    ...
    public static List<Dish> getAllDishes() {
        ...
        dishes.add(new Dish("Pancit", Arrays.asList("Rice noodles", "Chicken", "Pork", "Shrimp")));
        dishes.add(new Dish("Sinigang na Baboy", Arrays.asList("Pork", "Tamarind", "Radish", "Okra")));
        dishes.add(new Dish("Adobong Manok", Arrays.asList("Chicken ", "Soy sauce", "Vinegar", "Garlic", "Bay leaves")));
        dishes.add(new Dish("Tinola", Arrays.asList("Chicken", "Ginger", "Garlic", "Chili leaves", "Green papaya")));
        dishes.add(new Dish("Bistek Tagalog", Arrays.asList("Beef slices", "Soy sauce", "Calamansi juice", "Onions")));
        ...
        dishes.add(new Dish("Paksiw na Lechon", Arrays.asList("Lechon", "Vinegar", "Soy sauce", "Garlic", "Bay leaves")));
        ...
        dishes.add(new Dish("Escabeche", Arrays.asList("Tilapia", "Bell peppers", "Carrots", "Onions", "Vinegar", "Soy sauce", "Sugar")));
        ...
        dishes.add(new Dish("Puto Bumbong", Arrays.asList("Glutinous rice", "Pandan leaves", "Purple food coloring", "Coconut", "Sugar")));
        ...
        dishes.add(new Dish("Palitaw", Arrays.asList("Glutinous rice flour", "Water", "Sugar", "Sesame seeds", "Grated coconut")));
        dishes.add(new Dish("Goto", Arrays.asList("Beef ", "Rice", "Beef shank", "Garlic", "Ginger")));
        dishes.add(new Dish("Tapsilog", Arrays.asList("Beef ", "Sinangag ", "Itlog ")));
